...
const BUFFER = Data.buffer([
  ...
  0x20, 0x07, 0xd0, 0x00, 0x08, 0x0a, 0x66, 0x64, 0xe7, 0x00, 0x86, 0x00, 0xa8, 0x00, 0x7c, 0x00,
  0x8a, 0x00, 0x35, 0x00, 0x32, 0x02, 0x83, 0x04, 0xa2, 0x00, 0x15, 0x00, 0x05, 0x07, 0x99, 0x64,
  0xd9, 0x00, 0xfc, 0x00, 0x76, 0x00, 0xba, 0x00, 0x52, 0x00, 0x17, 0x09, 0x28, 0x37, 0x2c, 0x16,
  0x14, 0x0a, 0x44, 0x00, 0x00, 0x6a, 0x11, 0x64, 0x11, 0x01, 0x9e, 0x00, 0xb2, 0x00, 0x76, 0x00,
  ...
  0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x1a, 0x83, 0x19, 0x01, 0x00, 0x01, 0xc4, 0x00, 0xf6, 0x00,
  ...
  0x08, 0x0a, 0x82, 0x00, 0x00, 0x20, 0x33, 0x64, 0x19, 0x01, 0x00, 0x01, 0xc4, 0x00, 0xf6, 0x00,
  0x92, 0x00, 0x7b, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x3b, 0x01, 0x14, 0x1a, 0x26, 0x05, 0x46, 0x09, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x41, 0x79,
...
describe('Gen 1', () => {
  ...
  it('serialize/deserialize', () => {
    ...
    expect(p2.active!.species).toBe('scyther');
    expect(p2.active!.types).toEqual(['Bug', 'Flying']);
    expect(p2.active!.hp).toBe(230);
    expect(p2.active!.stats.spa).toBe(146);
    expect(p2.active!.move(2)).toEqual({id: 'bind', pp: 26});
