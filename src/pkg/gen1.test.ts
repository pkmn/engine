...
import {LAYOUT, Lookup} from './data';
import {Battle} from './gen1';

// FIXME: modify buffer to have specific points of interest (toxic, volatiles, etc)
const BUFFER = Buffer.from([
  0x11, 0x01, 0xda, 0x00, 0x16, 0x01, 0x9e, 0x00, 0xce, 0x00, 0x9b, 0x03, 0x4b, 0x0f, 0x2a, 0x18,
  0x52, 0x0a, 0x0c, 0x01, 0x00, 0x6e, 0x33, 0x64, 0x07, 0x01, 0x02, 0x01, 0xb2, 0x00, 0xee, 0x00,
  0x9e, 0x00, 0x1b, 0x03, 0x18, 0x1e, 0x77, 0x0e, 0x24, 0x11, 0xd3, 0x00, 0x00, 0x55, 0x20, 0x64,
  ...
  0x11, 0x01, 0xda, 0x00, 0x16, 0x01, 0x9e, 0x00, 0xce, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x9b, 0x03, 0x4b, 0x0f, 0x2a, 0x18, 0x52, 0x0a, 0x00, 0x00, 0x30, 0x6e, 0x33,
  ...
  0xc3, 0x01, 0x37, 0x01, 0x00, 0xe0, 0xcc, 0x88, 0xc7, 0x28, 0x6c, 0x96, 0x72, 0x1a, 0x45, 0x00,
]);
...
describe('Gen 1', () => {
  ...
  it('serialize/deserialize', async () => {
    ...
    const actual = Battle.encode(gen, lookup, battle);
