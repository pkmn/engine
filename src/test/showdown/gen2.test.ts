...
const QKC = {key: 'sim/battle.ts:1769:49', value: MAX};
...
describe('Gen 2', () => {
  ...
  test('Flinch effect', () => {
    ...
    const rock = {key: 'data/mods/gen2/scripts.ts:459:66', value: ranged(30, 256) - 1};
    const battle = startBattle([
  ...
  test('Conversion2 effect', () => {
    const proc = {key: 'data/moves.ts:2937:28', value: MAX};
    const battle = startBattle([QKC, proc, QKC], [
  ...
  test('Spite effect', () => {
    const spite2 = {key: 'data/mods/gen3/moves.ts:617:22', value: ranged(0, 4)};
  ...
  test('Magnitude effect', () => {
    const mag8 = {key: 'data/moves.ts:11313:19', value: ranged(85, 100) - 1};
