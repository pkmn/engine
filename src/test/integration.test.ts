...
class RawBattleStream extends BattleStreams.BattleStream {
  ...
  _writeLine(type: string, message: string) {
    ...
    if (type === 'start') {
      ...
      case 'gen1customgame':
      case 'gen2customgame':
        this.battle!.prng = Gen12RNG.fromPRNGSeed(this.battle!.prng.seed);
        break;
      case 'gen3customgame':
      case 'gen4customgame':
        this.battle!.prng = Gen34RNG.fromPRNGSeed(this.battle!.prng.seed);
        break;
      case 'gen5customgame':
      case 'gen6customgame':
        this.battle!.prng = Gen56RNG.fromPRNGSeed(this.battle!.prng.seed);
        break;
      default:
