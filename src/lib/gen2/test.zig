...
// test "Item.PSNCureBerry" {
//     // (Gen 2) Holder is cured if it is poisoned. Single use.
//     return error.SkipZigTest;
// }

// test "Item.SoftSand" {
//     // Holder's Ground-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.SharpBeak" {
//     // Holder's Flying-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.PRZCureBerry" {
//     // (Gen 2) Holder cures itself if it is paralyzed. Single use.
//     return error.SkipZigTest;
// }

// test "Item.BurntBerry" {
//     // (Gen 2) Holder is cured if it is frozen. Single use.
//     return error.SkipZigTest;
// }
...
// test "Item.PoisonBarb" {
//     // Holder's Poison-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }
...
// test "Item.SilverPowder" {
//     // Holder's Bug-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.MysticWater" {
//     // Holder's Water-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.TwistedSpoon" {
//     // Holder's Psychic-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.BlackBelt" {
//     // Holder's Fighting-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.BlackGlasses" {
//     // Holder's Dark-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.{PinkBow,PolkadotBow}" {
//     // (Gen 2) Holder's Normal-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.NeverMeltIce" {
//     // Holder's Ice-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.Magnet" {
//     // Holder's Electric-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.MiracleBerry" {
//     // (Gen 2) Holder cures itself if it is confused or has a status condition. Single use.
//     return error.SkipZigTest;
// }

// test "Item.SpellTag" {
//     // Holder's Ghost-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.MiracleSeed" {
//     // Holder's Grass-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }
...
// test "Item.HardStone" {
//     // Holder's Rock-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.Charcoal" {
//     // Holder's Fire-type attacks have 1.1x power.
//     return error.SkipZigTest;
// }

// test "Item.BerryJuice" {
...
// test "Item.MetalCoat" {
//     // Holder's Steel-type attacks have 1.1x power. Evolves Onix into Steelix and Scyther into
//     // Scizor when traded.
//     return error.SkipZigTest;
// }
...
// test "Move.{KarateChop,RazorLeaf,Crabhammer,Slash,Aeroblast,CrossChop}" {
//     // Has a higher chance for a critical hit.
//     return error.SkipZigTest;
// }

// test "Move.{DoubleSlap,CometPunch,FuryAttack,PinMissile,SpikeCannon,Barrage,FurySwipes,BoneRush}" {
...
// test "Move.{FirePunch,Ember,Flamethrower,FireBlast,FlameWheel}" {
//     // Has a 10% chance to burn the target.
//     return error.SkipZigTest;
// }

// test "Move.{IcePunch,IceBeam,Blizzard,PowderSnow}" {
//     // Has a 10% chance to freeze the target.
//     return error.SkipZigTest;
// }

// test "Move.{ThunderPunch,ThunderShock,Thunderbolt}" {
//     // Has a 10% chance to paralyze the target.
//     return error.SkipZigTest;
// }

// test "Move.{Guillotine,HornDrill}" {
...
// test "Move.{Bind,Wrap,FireSpin,Clamp,Whirlpool}" {
...
// test "Move.{DoubleKick,Bonemerang}" {
...
// test "Move.{RollingKick,Headbutt,Bite,LowKick,RockSlide}" {
//     // Has a 30% chance to make the target flinch.
//     return error.SkipZigTest;
// }

// test "Move.{SandAttack,Smokescreen,Kinesis,Flash}" {
//     // Lowers the target's accuracy by 1 stage.
//     return error.SkipZigTest;
// }

// test "Move.{BodySlam,Lick,Spark,DragonBreath}" {
//     // Has a 30% chance to paralyze the target.
//     return error.SkipZigTest;
// }

// test "Move.{TakeDown,Submission}" {
...
// test "Move.{Thrash,PetalDance,Outrage}" {
...
// test "Move.DoubleEdge" {
//     // If the target lost HP, the user takes recoil damage equal to 1/4 the HP lost by the target,
//     // rounded down, but not less than 1 HP. If this move hits a substitute, the recoil damage is
//     // always 1 HP.
//     return error.SkipZigTest;
// }

// test "Move.{TailWhip,Leer}" {
//     // Lowers the target's Defense by 1 stage.
//     return error.SkipZigTest;
// }

// test "Move.{PoisonSting,Sludge,SludgeBomb}" {
...
// test "Move.{Supersonic,ConfuseRay,SweetKiss}" {
//     // Causes the target to become confused.
//     return error.SkipZigTest;
// }

// test "Move.SonicBoom" {
//     // Deals 20 HP of damage to the target.
//     return error.SkipZigTest;
// }
...
// test "Move.{Psybeam,Confusion}" {
//     // Has a 10% chance to confuse the target.
//     return error.SkipZigTest;
// }

// test "Move.{BubbleBeam,Constrict,Bubble}" {
//     // Has a 10% chance to lower the target's Speed by 1 stage.
//     return error.SkipZigTest;
// }

// test "Move.AuroraBeam" {
...
// test "Move.Absorb" {
//     // The user recovers 1/2 the HP lost by the target, rounded down. If the target has a
//     // substitute, this move misses.
//     return error.SkipZigTest;
// }

// test "Move.{MegaDrain,LeechLife,GigaDrain}" {
...
// test "Move.Earthquake" {
//     // Power doubles if the target is using Dig.
//     return error.SkipZigTest;
// }
...
// test "Move.DoubleTeam" {
//     // Raises the user's evasiveness by 1 stage.
//     return error.SkipZigTest;
// }

// test "Move.{Recover,SoftBoiled,MilkDrink}" {
//     // The user restores 1/2 of its maximum HP, rounded down.
//     return error.SkipZigTest;
// }

// test "Move.{Harden,Withdraw}" {
//     // Raises the user's Defense by 1 stage.
//     return error.SkipZigTest;
// }

// test "Move.Minimize" {
//     // Raises the user's evasiveness by 1 stage. Whether or not the user's evasiveness was changed,
//     // Stomp will have its power doubled if used against the user while it is active. Baton Pass can
//     // be used to transfer this effect to an ally.
//     return error.SkipZigTest;
// }

// test "Move.DefenseCurl" {
...
//     // Metronome, Mimic, Mirror Coat, Protect, Sketch, Sleep Talk, Struggle, or Thief.
//     return error.SkipZigTest;
// }
...
// test "Move.{SelfDestruct,Explosion}" {
...
// test "Move.{BoneClub,HyperFang}" {
//     // Has a 10% chance to make the target flinch.
//     return error.SkipZigTest;
// }

// test "Move.{Swift,FeintAttack,VitalThrow}" {
...
// test "Move.{CottonSpore,ScaryFace}" {
...
// test "Move.{MorningSun,Synthesis,Moonlight}" {
